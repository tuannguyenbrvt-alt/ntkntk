            ...
            <div class="card-body p-0">
                <div class="list-group list-group-flush bg-transparent">
                    <?php foreach($subFiles as $index => $file): ?>
                        <div class="list-group-item bg-transparent text-white border-secondary border-opacity-25 p-3 d-flex align-items-center justify-content-between flex-wrap gap-2">
